...
def add_event(request):
    ...
    if eid=='' or name ==''or limit=='' or address=='' or start_time=='':
        return JsonResponse({'status':10021,'message':'parameter erros'})
...
def add_guest(request):
    ...
    try: Guest.objects.create(realname=realname,phone=int(phone),email=email,
